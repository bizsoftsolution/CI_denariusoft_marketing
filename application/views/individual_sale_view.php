            ...
            <div class="col-md-12">
               <div class="panel panel-primary">
                  <div class="panel-heading">
                     <h3 class="panel-title">Product Sale Table</h3>
                  </div>
  ...
  ?>';
   ...
   $(document).ready(function() {
       ...
       table = $('.table').DataTable({
           ...
           "ajax": {
               "url": "<?php echo base_url('Closed_Sale_Individual/ajax_list');  ?>",
               "type": "POST"
           },
           dom: 'Bfrtip',
           buttons: [
   ...
   function edit_product(product_id)
   {
       ...
       $.ajax({
           ...
           success: function(data)
           {
               ...
               $('[name="log_date"]').datepicker('update',data.log_date);
               ...
               <div class="modal-body form">
                   <form action="#" id="form" class="form-horizontal">
                       ...
                       <div class="form-body">
                           ...
                           <div class="form-group">
                               <label class="control-label col-md-3">Log Date </label>
                               <div class="col-md-9">
                                   <input name="log_date" placeholder="yyyy-mm-dd" class="form-control datepicker" type="text">
