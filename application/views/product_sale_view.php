<div class="content-page">
   <div class="content">
      <div class="container">
         ...
         <div class="">
           <div class="col-md-12">
             <button class="btn btn-danger" onclick="new_sale()"><i class="glyphicon glyphicon-plus"></i> New Sale</button>
  ...
  ?>';
   ...
   $(document).ready(function() {
       ...
       table = $('.table').DataTable({
           ...
           "ajax": {
               "url": "<?php echo base_url('Product_sales/product_list');
  ?>",
               "type": "POST"
           },
   ...
   function edit_sale($product_sale_id)
   {
       save_method = 'update';
    $('#form')[0].reset(); // reset form on modals
    $('.form-group').removeClass('has-error'); // clear error class
    ...
    $.ajax({
        url : "<?php echo base_url('Product_sales/Product_edit')?>/" + $product_sale_id,
        type: "GET",
        dataType: "JSON",
   ...
   function save()
   {
    ...
    if(save_method == 'add') {
        url = "<?php echo base_url('Product_sales/product_add')?>";
    } else {
        url = "<?php echo base_url('Product_sales/product_update')?>";
    }
                   ...
                   <form action="#" id="form" class="form-horizontal">
                       ...
                       <div class="form-body">
                           <div class="form-group">
                            ...
                            <div class="col-md-9">
                                <input name="buyer_company" placeholder="Buyer Company" class="form-control" type="text">
                                <span class="help-block"></span>
                            </div>
                        </div>
