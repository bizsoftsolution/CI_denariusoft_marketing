...
class ClosedSaleIndividualModel extends CI_Model {

	var $table = 'tbl_mk_product_sale';
	var $column_order = array('product_id','buyer_company','contact_person','insert_date'); //set column field database for datatable orderable
	var $column_search = array('product_id','buyer_company'); //set column field database for datatable searchable just firstname , lastname , address are searchable
  ...
  //  $this->db->join('tbl_employee e', 't.emp_no ='.$emp_no,'left');
